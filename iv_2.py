# -*- coding: utf-8 -*-
#py.bat iv_2.py 10 C:\Users\alex_\OneDrive\Pictures\Sony7rM4\55mm\protest\1-20-2019\insta_base jpg
...
class ViewerPanel( wx.Window):
    ...
    def __init__(self, parent):
        ...
        if 1:
            ...
            self.Bind(wx.EVT_TIMER, self.watch, self.timer)
    ...
    def showMsg(self,msg, timeout=3000, clean=True):  
        ...
        font = wx.Font(450*(self.NewW+ (self.dw-self.NewW)/3)/self.dw, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.BOLD, False)
        text.SetFont(font)
